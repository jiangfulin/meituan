...
//detailInfo
export const FETCH_DETAILINFO_DATA = 'FETCH_DETAILINFO_DATA';
export const INFO_ISGOODORTOP_BOL = 'INFO_ISGOODORTOP_BOL';
export const INFO_ISCOLLECT_BOL = 'INFO_ISCOLLECT_BOL';
//userInfo
export const FETCH_USERINFO_DATA = 'FETCH_USERINFO_DATA'
//common
export const FETCH_ISLOADING_BOL = 'FETCH_ISLOADING_BOL'
//login

export const FETCH_ISLOGIN_BOL = 'FETCH_ISLOGIN_BOL'

//logout
export const FETCH_LOGOUT_BOL = 'FETCH_LOGOUT_BOL'
